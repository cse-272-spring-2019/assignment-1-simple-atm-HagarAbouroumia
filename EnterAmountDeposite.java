...
public class EnterAmountDeposite {
    ...
    public EnterAmountDeposite(Stage stage) {
        this.stage = stage;
    }
    ...
    public void prepareScene() {
        ...
        submit.setOnAction(new EventHandler<ActionEvent>() {
            public void handle(ActionEvent event) {
                String amountEntered = textField.getText();
                authentication.deposit(amountEntered);
                validationLabel.setText("Sucess");
                transaction.transaction(amountEntered, "  Deposit ");
